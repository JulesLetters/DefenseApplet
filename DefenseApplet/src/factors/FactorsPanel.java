...
public class FactorsPanel extends JPanel implements ISpinnerListener {
	...
	public FactorsPanel(EventBus eventBus) {
		...
		hpDenominator = new LabelledSpinner("divided by", 1, 0, 200, 1);
		defNumerator = new LabelledSpinner("Def:", 1, 1, 200, 1);
		defDenominator = new LabelledSpinner("divided by", 1, 0, 200, 1);
		spDefNumerator = new LabelledSpinner("SpDef:", 1, 1, 200, 1);
		spDefDenominator = new LabelledSpinner("divided by", 1, 0, 200, 1);
